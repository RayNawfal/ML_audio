...
DATASET_PATH =  "/home/*******/data/mini_speech_commands" #'data/mini_speech_commands'
...
fig, axes = plt.subplots(2, figsize=(12, 10)) #8
...
#export(tf.constant(str(data_dir/'off/1ba20be2_nohash_0.wav'))) 
#/home/data/mini_speech_commands/off/off-16.36.15.wav
